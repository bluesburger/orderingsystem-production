...
public class PerformBillingFailedEvent extends OrderEvent {

	public static final String EVENT_NAME = "COBRANCA_FALHOU";
	
	private static final long serialVersionUID = 7702500048926979660L;
	
	@JsonCreator
	public PerformBillingFailedEvent(@JsonProperty("orderId") String orderId) {
		super(orderId);
	}
